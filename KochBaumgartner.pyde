...
#Bilder laden
    ...
    if mouseY>y-125 and mouseX>x+410: image(bilder[15], 240, 180)
    elif mouseY>y-125 and x+250<mouseX<x+375: image(bilder[14], 240, 180)
    elif mouseY>y-125 and x+125<mouseX<x+250: image(bilder[13], 240, 180)
    elif mouseY>y-125 and mouseX<x+125: image(bilder[12], 240, 180) 
    ...
    elif y-125>mouseY>y-250 and mouseX<x+125: image(bilder[8], 240, 180) 
    ...
    elif y-250>mouseY>y-375 and mouseX<x+125: image(bilder[4], 240, 180) 
    ...
    elif mouseY<y-375 and mouseX<x+125: image(bilder[0], 240, 180)
